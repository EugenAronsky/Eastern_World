    ...
    return(
        <div className='Biography' style={home_background_image.fields.file.url === "default" ? {} : {backgroundImage : "url(" + home_background_image.fields.file.url +")" }}>
            ...
            <div className = "Bio-button">
                {screenWidth <= 540 ? <Button content = "УЗНАТЬ БОЛЬШЕ" width = "40.625vw" height = "9.375vw" link={'/biography'}/> : <Button content = "УЗНАТЬ БОЛЬШЕ" width = "13.542vw" height = "3.125vw" link={'/biography'}/>}
            </div>
        </div>
    );
}
