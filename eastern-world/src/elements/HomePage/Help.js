    ...
    return(
        <div className='Help'>
            ...
            <div className='help-button'>
                {screenWidth <= 540 ? <Button content = "УЗНАТЬ БОЛЬШЕ" width = "40.625vw" height = "9.375vw" link={"/help"} /> : <Button content = "УЗНАТЬ БОЛЬШЕ" width = "13.542vw" height = "3.125vw" link={"/help"}/>}
            </div>
